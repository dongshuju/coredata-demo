...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.AlexCevallos.MyDevices" in the application's documents Application Support directory.
    ...
    func creatTestDataIfNeed() {
        ...
        guard let libraries = try! self.persistentContainer.viewContext.fetch(Library.fetchRequest()) as? [Library] else {
